...
import 'package:social_app/Cahche_helper.dart';
        ...
        child: BlocProvider(
          ...
          child: BlocConsumer<LoginCubit, LoginState>(
            listener: (context, state) {
              if (state is UserStoreSuccessState) {
...
registerBuilder(TextEditingController emailController,
                        ...
                        MaterialButton(
                          onPressed: () {
                            if (passwordController.text ==
                              ...
                              showToast(
                                  msg: 'two password must be identical',
